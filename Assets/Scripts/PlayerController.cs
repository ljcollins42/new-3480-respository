...
public class PlayerController : MonoBehaviour
{
        ...
        if(whatDidIHit.tag == "Powerup")
        {
            ...
            switch (whichPowerup)
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    weaponType = 4; //Picked up shield
                    StartCoroutine(WeaponPowerDown());
                    if (shieldPrefab.activeInHierarchy)
                    {
                        //If I already have a shield, do not activate another one, but instead give me points
    ...
    void Shooting()
    {
        ...
        else if(Input.GetKeyDown(KeyCode.E))
        {
            ...
            {
                case 1:
                    Instantiate(secondBullet, transform.position + new Vector3(0, 0.5f, 0), Quaternion.identity);
                    break;
                case 2:
                    Instantiate(secondBullet, transform.position + new Vector3(0.5f, 0.5f, 0), Quaternion.identity);
                    Instantiate(secondBullet, transform.position + new Vector3(0.5f, 0.5f, 0), Quaternion.identity);
                    break;
                case 3:
                    Instantiate(secondBullet, transform.position + new Vector3(0.5f, 0.5f, 0), Quaternion.Euler(0, 0, 45));
                    Instantiate(secondBullet, transform.position + new Vector3(0, 0.5f, 0), Quaternion.identity);
                    Instantiate(secondBullet, transform.position + new Vector3(0.5f, 0.5f, 0), Quaternion.Euler(0, 0, 45));
                    break;
            }
